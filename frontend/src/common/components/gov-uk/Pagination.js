...
export default function Pagination ({
  ...
  const pageListItem = (index) => {
    ...
    return (
      <>
        <li className={pageNumber === currentPage ? 'govuk-pagination__item govuk-pagination__item--current' : 'govuk-pagination__item'}>
          <a
            className='govuk-link govuk-pagination__link' href='#' aria-label='Page 1' aria-current={pageNumber === currentPage ? 'page' : undefined}
            onClick={(e) => {
              e.preventDefault()
    ...
    <>
      ...
      {pageList && totalPages > 1 && (
        <nav className='govuk-pagination' aria-label='Pagination'>
          <div className='govuk-pagination__prev'>
            <a
              className='govuk-link govuk-pagination__link' href='#' rel='prev'
          ...
          <div className='govuk-pagination__next'>
            <a
              className='govuk-link govuk-pagination__link' href='#' rel='next'
