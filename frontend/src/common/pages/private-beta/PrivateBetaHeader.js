...
export default function PrivateBetaHeader({ type }) {
    ...
    <>
      ...
      >
        <div
          ...
          id='main-content'
          aria-label='This is a test service only - do not rely on this for flood warnings'
        >
          <FontAwesomeIcon
        ...
        {infoOpen && (
          ...
          >
            <p>
              Thank you for taking part in our trial for our new flood warning
              service.
            </p>
            ...
            <p>
              If you need live flood warnings, &nbsp;
              <a
            ...
            <p>
              If you need to contact us about this test service or our trial
              phase, email us at
              <br />
              <a
