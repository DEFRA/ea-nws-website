...
export default function UpdateContactAndNavigate (setError, message) {
  ...
  const navigateToNextPage = async () => {
    const contactToUpdate = store.getState().session.orgCurrentContact
    const dataToSend = { authToken, orgId, contact: contactToUpdate }
    ...
    // TODO: Enable once Geosafe returns contact IDs
    // if (data) {
