        ...
        <div className='govuk-grid-row'>
          <div className='govuk-grid-column-two-thirds'>
            ...
            <p className='govuk-body'>
              Adding optional information allows you to filter your organisation's locations
              and helps you identify them more easily.
            </p>
            ...
            <ul className='govuk-list'>
              <li>
                ...
                <p className='govuk-body'>
                  If you add a location as X and Y coordinate you can
                  add an address. This address will then be associated
                  with the location.
                </p>
              </li>
              <li>
                ...
                <ul class='govuk-list govuk-list--bullet'>
                  ...
                  <li>
                    ...
                    <p className='govuk-body'>
                      For example, pumping station, ground floor flat,
                      office, retail unit.
                    </p>
                  </li>
                </ul>
