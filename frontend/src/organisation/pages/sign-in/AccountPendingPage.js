      ...
      <main className='govuk-main-wrapper govuk-!-padding-top-4'>
        <div className='govuk-grid-row'>
          <div className='govuk-grid-column-two-thirds'>
            ...
            <h3 className='govuk-heading-s govuk-!-margin-bottom-1'>Personal sign up</h3>
            <Link
              to='/signup'
            ...
            <h3 className='govuk-heading-s govuk-!-margin-bottom-1 govuk-!-margin-top-2'>Organisation sign up </h3>
            ...
            <p>
              Your account may still be pending approval and you will
              not be able to sign in until it’s approved.
            </p>
            <p>
              It usually takes us 2 to 3 working days to approve an account and you should
              hear from us soon.
            </p>
            <p>
              You can {' '}
