...
url = "http://localhost:3000/organisation/register/address"
nextPage = "http://localhost:3000/organisation/register/address-search"
...
def test_invalid_input(get_browser):
    browser = get_browser 
    browser.get(url)
    input_field = browser.find_element(By.NAME, "Organisation postcode")
